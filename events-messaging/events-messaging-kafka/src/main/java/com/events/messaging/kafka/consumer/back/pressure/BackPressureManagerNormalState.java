...
public class BackPressureManagerNormalState implements BackPressureManagerState {
  ...
  public static BackPressureManagerStateAndActions transitionTo(
      Set<TopicPartition> suspendedPartitions) {
    return new BackPressureManagerStateAndActions(
        BackPressureActions.resume(suspendedPartitions), new BackPressureManagerNormalState());
  }

  @Override
  public BackPressureManagerStateAndActions update(
