...
public abstract class SagaLockManagerImplSchemaTest {
  ...
  public void testInsertIntoSagaLockTable() {
    Assert.assertEquals(
        ...
        getSagaLockManagerSql().getInsertIntoSagaLockTableSql());
  }
  ...
  public void testSelectFromSagaLockTable() {
    Assert.assertEquals(
        ...
        getSagaLockManagerSql().getSelectFromSagaLockTableSql());
  }
  ...
  public void testSelectFromSagaStashTable() {
    Assert.assertEquals(
        ...
        getSagaLockManagerSql().getSelectFromSagaStashTableSql());
  }

  @Test
  public void testUpdateSagaLockTable() {
    Assert.assertEquals(
        getExpectedUpdateSagaLockTable(), getSagaLockManagerSql().getUpdateSagaLockTableSql());
  }
  ...
  public void testDeleteFromSagaLockTable() {
    Assert.assertEquals(
        ...
        getSagaLockManagerSql().getDeleteFromSagaLockTableSql());
  }
  ...
  public void testDeleteFromSagaStashTable() {
    Assert.assertEquals(
        ...
        getSagaLockManagerSql().getDeleteFromSagaStashTableSql());
  }
